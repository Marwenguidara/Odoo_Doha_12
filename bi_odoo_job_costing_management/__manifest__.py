...
""",
    ...
    'depends': ['base','sale_management','project','purchase','account','hr_timesheet','note','stock','document','hr_timesheet_attendance','bi_subtask','drawing','bi_material_purchase_requisitions'],  #
    'data': [
